                  ...
                  <div class="card-body">
                    ...
                    <table class="table">
					  ...
					  { ?>
                        ...
                        <tr>
                          <td><?php echo $i; ?></td>
                          <td><?php echo $data['added_data'];?></td>
					  ...
					  <?php } ?>
                          ...
                          <td> 
						  <a href="edit-team.php?editid=<?php echo $data['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true" style="width:20px; height:20px;"></a></i>
						  
						  <a href="all-team.php?delid=<?php echo $data['id'];?>" onclick="return confirm('Do you want to delete this data')"><i class="fa fa-trash" aria-hidden="true"></i></a>
