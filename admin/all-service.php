...
if(isset($_GET['delid']))
{
	$delresult=deletedata('gard_services',$_GET['delid']);
                ...
                <div class="card">
                  ...
                  <div class="card-body">
					...
					<table class="table">
					  ...
					  $servicesdata=fetchalldata('gard_services');  
					  $i=1;
					  ...
					  { ?>
                        ...
                        <tr>
                          ...
                          <td><img src="uplodes/<?php echo $data['icon'];?>"style="height:80px; width:auto; border-radius:0;"></td>
                          <td>
						  	  <?php 
						  if($data['status']==1){ ?>
					  ...
					  <?php } ?>
                          ...
                          <td> 
						  <a href="edit-service.php?editid=<?php echo $data['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true" style="width:20px; height:20px;"></a></i>
						  
						  <a href="all-service.php?delid=<?php echo $data['id'];?>" onclick="return confirm('Do you want to delete this data')"><i class="fa fa-trash" aria-hidden="true"></i></a>
