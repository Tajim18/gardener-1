...
if(isset($_GET['delid']))
{
	$delresult=deletedata('gard_projects',$_GET['delid']);
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <table class="table">
					  ...
					  $i=1;
					  while($data=mysqli_fetch_array($projectdata))
					  ...
					  <?php } ?>
                          ...
                          <td> 
						  <a href="edit-projects.php?editid=<?php echo $data['id'];?>"><i class="fa fa-pencil-square-o" aria-hidden="true" style="width:20px; height:20px;"></a></i>
						  
						  <a href="all-project.php?delid=<?php echo $data['id'];?>" onclick="return confirm('Do you want to delete this data')"><i class="fa fa-trash" aria-hidden="true"></i></a>
